...
export const ServiceRequestDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nirLirApp.serviceRequest.delete.question">
        <Translate contentKey="nirLirApp.serviceRequest.delete.question" interpolate={{ id: serviceRequestEntity.id }}>
