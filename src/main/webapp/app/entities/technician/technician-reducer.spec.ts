...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TECHNICIAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_TECHNICIAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TECHNICIAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TECHNICIAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TECHNICIAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TECHNICIAN actions', async () => {
      const expectedActions = [
        {
